		...
		<div class="food" v-show="showFlag" ref='foodWrapper'>
			<div class="food-content">
			    ...
			    <div class="rating">
			    	...
			    	<rating-select :select-type="selectType" @select="selectRating" @togglecontent="toggleContent" :ratings="food.ratings" :only-content="onlyContent" :desc="desc"></rating-select>
